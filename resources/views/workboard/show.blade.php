...
<div class="container-fluid ml-5 mb-3">
    ...
    <div class="d-flex align-items-start w-100 px-5 pb-1 listt-sortable" style="overflow-x: auto; @if($board->members->count() > 0) height: calc((100vh - 75px) - (68px + 1.5rem)); @else height: calc((100vh - 43px) - (68px + 1.5rem)); @endif">
